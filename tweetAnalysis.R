...
# start_date_data <- as.Date("2020-06-01") # Myanmar
end_date_data <- as.Date("2020-08-13")
...
if (loc == "delhi"){
  ...
  daily_case_since_0626 <- diff(c(73780,77240,80188,83077,85161,87360,89802,92175,94695,97200,99444,
                                  ...
                                  130606,131219,132275,133310,134403,135598,136716,137677,138482,139156,
                                  140232,141531,142723,144127,145427,146134,147391,148504,149460))
  cum_hosp_since_0626 <- c(27657,30149,30887,30470,26270,27007,26304,26148,25940,25038,25620,25449,23452,21567,21146,
                           ...
                           11904,10994,10887,10770,10743,10705,10596,10356,10207,9897,10072,10348,10409,10667,10729,
                           10346,10868,10946,10975)
  ...
  daily_case_since_0626 <- diff(c(147741,152765,159133,164626,169883,174761,180298,186626,
                                  ...
                                  411798,422118,431719,441228,450196,457956,468265,479779,490262,
                                  503084,515332,524513,535601,548313,560126))
  cum_hosp_since_0626 <- c(65829,72950,74888,78051,75979,79075,77260,79911,83295,86040,87682,89294,91065,93654,95647,
                           ...
                           143714,145481,148601,147592,144694,146129,148150,150662,149214,148537,147018,142151,145961,
                           146305,145582,147048,145558,147735,148553,147513,149798)
  ...
  daily_case <- diff(c(2823,2902,3033,3112,3279,3399,3506,3605,3681,3746,3832,3950,4033,4138,
                       ...
                       18623,19001,19473,19885,20470,20769,21201,21575,21954,22443,22909,23266,23863,
                       24521,25242,25714,26193,26664,27242,27863))
  hospital <- c(1373,1468,1476,1480,1486,1496,1499,860,871,885,903,945,969,982,
                ...
                981,780,1136,1067,1158,1379,1608,1860,2070,1557,1563,1546,1585,1585,1617,1656,1974,
                1841,1854,1941,1787,1573,1549,1483,1722,1573,1411,1221) + 
    c(1727,1769,1839,1826,1935,1985,2010,1988,1947,1952,1950,2024,2002,2073,
      ...
      1193,1201,1300,1410,1491,1702,1848,1944,2049,2183,2153,2159,2327,2432,2483,2552,2595,
      2488,2416,2555,2548,2717,2714) # since 2020-4-17, Only ICU
  ...
  daily_case <- ceiling(c(33,32,27,19,15,13,15,53,15,9,7,9,7,6,6,3,
                          ...
                          6,1,5,5,5,0,2,5,0,14,1,3,7,5,4,3,7,3,0,5,6,8,10,3,9,4,2,1,6,6,2,5,3,1,7,2,15,3,3,0,0,5,3)/2)
  hospital <- ceiling(c(964,899,790,746,655,425,359,314,309,277,270,232,228,213,187,180,176,
                        ...
                        124,126,128,129,135,127,119,117,120,121,126,124,139,140,142,133,130,129,132)/2) # since 2020-4-17
  ...
  daily_case <- c(4,4,1,3,0,4,2,2,2,2,12,1,0,0,1,0,0,1,23,1,3,0,2,1,0,0,0,6,0,0,4,1,2,7,0,3,0,1,2,
                  7,4,1,5,1,0,2,0,1,1,0,0,2,0,3,2,2,0,0,1,2,0,0,0,2,0,2,0,2,0,1,0,0,1,8)
  hospital <- c(80,84,83,82,82,79,78,80,79,81,77,89,90,88,88,81,77,71,70,88,85,84,84,82,79,76,72,71,
                ...
                54,52,51,51,52,51,50,49,47,47,46,43,44,42,42,42,41,37,42) # since 2020-05-31
...
predicted_epi_data <- predict_arima_func(start_date_data,vol_stm_daily,epi_data)
pre_daily_case_hosp <- predict_arima_daily_func(start_date_data,vol_stm_daily,epi_data)
